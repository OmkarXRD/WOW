...
public class CountryListAdapter extends RecyclerView.Adapter<CountryListAdapter.InnerClassAdapter> {
    ...
    public InnerClassAdapter onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new InnerClassAdapter( LayoutInflater.from( parent.getContext() ).inflate( R.layout.country_items, parent, false ) );
    }
