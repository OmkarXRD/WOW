...
public class LocalAddedAdapter extends RecyclerView.Adapter<LocalAddedAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public LocalAddedAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.local_added_rv_design, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull LocalAddedAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
