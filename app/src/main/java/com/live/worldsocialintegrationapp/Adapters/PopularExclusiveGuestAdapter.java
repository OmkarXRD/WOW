...
public class PopularExclusiveGuestAdapter extends RecyclerView.Adapter<PopularExclusiveGuestAdapter.InnerClassAdapter> {
    @NonNull
    @Override
    public InnerClassAdapter onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new InnerClassAdapter( LayoutInflater.from( parent.getContext() ).inflate( R.layout.popular_exclusive_items, parent, false ) );
    }
