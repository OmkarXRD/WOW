...
public class ApplyForAgencyFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        details = App.getSharedpref().getModel("RegisterRoot",RegisterRoot.class);
        ...
        if (details!=null){
            ...
            special_name.setText(App.getSharedpref().getString("username"));
            phone.setText(App.getSharedpref().getString("phone"));
        }
...
//        });
    ...
    private void applyForAgency() {
        ...
        data.put("username", CommonUtils.getRequestBodyText(App.getSharedpref().getString("username")));
        ...
        data.put("phone", CommonUtils.getRequestBodyText(App.getSharedpref().getString("phone")));
      ...
      //  data.put("bank_name", CommonUtils.getRequestBodyText(bankName));
       ...
       // data.put("payment_method", CommonUtils.getRequestBodyText(paymentMethodName));
        ...
        if (data==null){
            ...
            new Mvvm().agencyLiveData(data,CommonUtils.getFileData(user_image,"image"),
                ...
                public void onChanged(Map map) {
                    ...
                    RegisterRoot details = App.getSharedpref().getModel("RegisterRoot", RegisterRoot.class);
                    //sumit
                    ...
                    App.getSharedpref().saveModel("RegisterRoot", details);
                    //  requireActivity().onBackPressed();

//                    if (String.valueOf(map.get("status")).equalsIgnoreCase("1")) {
//                        RegisterRoot details = App.getSharedpref().getModel("RegisterRoot",RegisterRoot.class);
//                        //sumit
//                        //details.setAgency_status(map.get("status").toString());
//
...
//                    }
    ...
    public void onResume() {
        super.onResume();
//sumit
        getActivity().findViewById(R.id.bottom_lay).setVisibility(View.GONE);
