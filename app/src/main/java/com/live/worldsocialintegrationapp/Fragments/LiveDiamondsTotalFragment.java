...
public class LiveDiamondsTotalFragment extends Fragment implements LiveDiamondsRVAdapter.Callback{
    private RecyclerView liveDiamondTotalHistoryRv;
    private TextView livetotalDiamondTv,liveDiamondsTotalNoFoundTV;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_live_diamonds_total, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if(getArguments() !=  null){
            ...
            Toast.makeText(requireContext(), "total live "+liveId, Toast.LENGTH_SHORT).show();
        }else{
    ...
    private void findIds(View view) {
        liveDiamondTotalHistoryRv=view.findViewById(R.id.liveDiamondTotalHistoryRv);
        livetotalDiamondTv=view.findViewById(R.id.livetotalDiamondTv);
        liveDiamondsTotalNoFoundTV=view.findViewById(R.id.liveDiamondsTotalNoFoundTV);

    }
    private void getLiveDiamondsApi() {

        mvvm.getLiveDiamonds(requireActivity(),liveId,"0").observe(requireActivity(), new Observer<GetLiveDiamondRoot>() {
            @Override
            public void onChanged(GetLiveDiamondRoot getLiveDiamondRoot) {
                if(getLiveDiamondRoot != null){
                    if(getLiveDiamondRoot.getSuccess().equalsIgnoreCase("1")){
                        ...
                        livetotalDiamondTv.setText(getLiveDiamondRoot.getTotal());

                        if(list.isEmpty()){
                            liveDiamondsTotalNoFoundTV.setVisibility(View.VISIBLE);
                        }else{
                            liveDiamondsTotalNoFoundTV.setVisibility(View.GONE);
                            if (isAdded() && getContext() != null) {
                                liveDiamondsRVAdapter=new LiveDiamondsRVAdapter(getContext(),list,LiveDiamondsTotalFragment.this);
                                liveDiamondTotalHistoryRv.setAdapter(liveDiamondsRVAdapter);
                            }
                        }
                    }else{
                        liveDiamondsTotalNoFoundTV.setVisibility(View.VISIBLE);
...
//            bundle.putString("userId",detail.getReceiverId());
//            requireActivity().getSupportFragmentManager().beginTransaction().replace(R.id.nav_home,new OtherUser()).addToBackStack(null).commit();
//        }else {
//            Toast.makeText(requireContext(), "Detail null", Toast.LENGTH_SHORT).show();
//        }
