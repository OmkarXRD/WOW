...
public class RechargeActivity extends AppCompatActivity implements PaymentResultWithDataListener , ExternalWalletListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        alertDialogBuilder = new AlertDialog.Builder(RechargeActivity.this);
