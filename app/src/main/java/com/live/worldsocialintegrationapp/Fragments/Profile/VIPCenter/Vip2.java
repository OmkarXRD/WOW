...
public class Vip2 extends Fragment {
    ...
    private TextView vip2CoinsTv,vip2YouAreVipTV;

    private AppCompatButton sendButton, buyButton;
    private SVGAImageView framesImg2;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        vip2CoinsTv.setText(detail.getCoins() + "coins/"+detail.getValid()+"days");
        if (detail.isVip_status()){
            vip2YouAreVipTV.setText("You are VIP"+detail.getId());
        }else{
            vip2YouAreVipTV.setText("You are not VIP"+detail.getId());
        }

    }

    private void findIds(View view) {
        vip1Llayout = view.findViewById(R.id.viip2IconLlayout);
        uniqueFrameLlyout = view.findViewById(R.id.vip2UniqueFrameLlyout);
        entranceEffectLlayout = view.findViewById(R.id.vip2EntranceEffectLlayout);
        getThisCarLlayot = view.findViewById(R.id.vip2GetThisCarLlayot);
        friendLayout = view.findViewById(R.id.vip2FriendLayout);
        followingLyout = view.findViewById(R.id.vip2FollowingLyout);
        coinsDayLlayout = view.findViewById(R.id.vip2CoinsDayLlayout);
        colorMsgLlayout = view.findViewById(R.id.vip2ColorMsgLlayout);
        prventKickLlayout = view.findViewById(R.id.vip2PrventKickLlayout);
        antiBanLlayout = view.findViewById(R.id.vip2AntiBanLlayout);
        hiddenLlayout = view.findViewById(R.id.vip2HiddenLlayout);
        MysteryManLlayout = view.findViewById(R.id.vip2MysteryManLlayout);
        flyingCommentLlayout12 = view.findViewById(R.id.vip2FlyingCommentLlayout12);
        exclusiveGiftlLayout = view.findViewById(R.id.vip2ExclusiveGiftlLayout);
        hideCountryOnlineLlayout = view.findViewById(R.id.vip2HideCountryOnlineLlayout);
        sendButton = view.findViewById(R.id.vip2SendBtn);
        buyButton = view.findViewById(R.id.vip2BuyBtn);

        vip2CoinsTv = view.findViewById(R.id.vip2CoinsTv);
        vip2YouAreVipTV = view.findViewById(R.id.vip2YouAreVipTV);


        framesImg2 = view.findViewById(R.id.framesImg2);
    ...
    private void clicks(View view) {
        ...
        sendButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                bundle.putString("giftType","VIP 2");
    ...
    private void setDialogs(View view) {
        ...
        friendLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                vip1FriendTv1.setText("x200%");
                vip1FriendTv2.setText("Friends *200%");
                vip1FriendTv3.setText("Increase your Friends limit *200%");
        ...
        followingLyout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                vip2FollowingTv1.setText("x200%");
                vip2FollowingTv2.setText("Following *200%");
                vip2FollowingTv3.setText("Increase your Following limit *200%");
        ...
        coinsDayLlayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                vip1CoinsTv1.setText("+1400");
                vip1CoinsTv2.setText("1400 coins/day");
                vip1CoinsTv3.setText("Get 1400 coins/day in Daily Reward. Refresh time. UTC+0");
