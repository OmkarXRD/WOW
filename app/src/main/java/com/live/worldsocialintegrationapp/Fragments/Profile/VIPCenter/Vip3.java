...
public class Vip3 extends Fragment {
    public static VipRoot.Detail detail;
    private TextView vipCoinsTV,vip3YouAreVipTV;
    ...
    private SVGAImageView framesImg3;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_vip3, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        vipCoinsTV.setText(detail.getCoins() + "coins/"+detail.getValid()+"days");
        if (detail.isVip_status()){
            vip3YouAreVipTV.setText("You are VIP"+detail.getId());
        }else{
            vip3YouAreVipTV.setText("You are not VIP"+detail.getId());
        }
    ...
    private void findIds(View view) {
        ...
        vip1Llayout = view.findViewById(R.id.viip3IconLlayout);
        uniqueFrameLlyout = view.findViewById(R.id.vip3UniqueFrameLlyout);
        entranceEffectLlayout = view.findViewById(R.id.vip3EntranceEffectLlayout);
        getThisCarLlayot = view.findViewById(R.id.vip3GetThisCarLlayot);
        friendLayout = view.findViewById(R.id.vip3FriendLayout);
        followingLyout = view.findViewById(R.id.vip3FollowingLyout);
        coinsDayLlayout = view.findViewById(R.id.vip3CoinsDayLlayout);
        colorMsgLlayout = view.findViewById(R.id.vip3ColorMsgLlayout);
        prventKickLlayout = view.findViewById(R.id.vip3PrventKickLlayout);
        antiBanLlayout = view.findViewById(R.id.vip3AntiBanLlayout);
        hiddenLlayout = view.findViewById(R.id.vip3HiddenLlayout);
        MysteryManLlayout = view.findViewById(R.id.vip3MysteryManLlayout);
        flyingCommentLlayout12 = view.findViewById(R.id.vip3FlyingCommentLlayout12);
        exclusiveGiftlLayout = view.findViewById(R.id.vip3ExclusiveGiftlLayout);
        hideCountryOnlineLlayout = view.findViewById(R.id.vip3HideCountryOnlineLlayout);
        sendButton = view.findViewById(R.id.vip3SendBtn);
        buyButton = view.findViewById(R.id.vip3BuyBtn);


        vipCoinsTV = view.findViewById(R.id.vip3CoinsTV);
        vip3YouAreVipTV = view.findViewById(R.id.vip3YouAreVipTV);

        framesImg3 = view.findViewById(R.id.framesImg3);
       ...
       buyButton.setOnClickListener(new View.OnClickListener() {
        ...
        sendButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                bundle.putString("giftType","VIP 3");
    ...
    private void setDialogs(View view) {
        ...
        friendLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                vip1FriendTv1.setText("x300%");
                vip1FriendTv2.setText("Friends *300%");
                vip1FriendTv3.setText("Increase your Friends limit *300%");
        ...
        followingLyout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                vip2FollowingTv1.setText("x300");
                vip2FollowingTv2.setText("Following *300%");
                vip2FollowingTv3.setText("Increase your Following limit *300%");
        ...
        coinsDayLlayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                vip1CoinsTv1.setText("+2800");
                vip1CoinsTv2.setText("2800 coins/day");
                vip1CoinsTv3.setText("Get 2800 coins/day in Daily Reward. Refresh time. UTC+0");
