...
public class Vip4 extends Fragment {

    public static VipRoot.Detail detail;
    private TextView vip4CoinsTV,vip4YouAreVipTV;
    ...
    private SVGAImageView framesImg4;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        return inflater.inflate(R.layout.fragment_vip4, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        vip4CoinsTV.setText(detail.getCoins() + "coins/"+detail.getValid()+"days");
        if (detail.isVip_status()){
            vip4YouAreVipTV.setText("You are VIP"+detail.getId());
        }else{
            vip4YouAreVipTV.setText("You are not VIP"+detail.getId());
        }
    ...
    private void findIds(View view) {
        ...
        vip1Llayout = view.findViewById(R.id.viip4IconLlayout);
        uniqueFrameLlyout = view.findViewById(R.id.vip4UniqueFrameLlyout);
        entranceEffectLlayout = view.findViewById(R.id.vip4EntranceEffectLlayout);
        getThisCarLlayot = view.findViewById(R.id.vip4GetThisCarLlayot);
        friendLayout = view.findViewById(R.id.vip4FriendLayout);
        followingLyout = view.findViewById(R.id.vip4FollowingLyout);
        coinsDayLlayout = view.findViewById(R.id.vip4CoinsDayLlayout);
        colorMsgLlayout = view.findViewById(R.id.vip4ColorMsgLlayout);
        prventKickLlayout = view.findViewById(R.id.vip4PrventKickLlayout);
        antiBanLlayout = view.findViewById(R.id.vip4AntiBanLlayout);
        hiddenLlayout = view.findViewById(R.id.vip4HiddenLlayout);
        MysteryManLlayout = view.findViewById(R.id.vip4MysteryManLlayout);
        flyingCommentLlayout12 = view.findViewById(R.id.vip4FlyingCommentLlayout12);
        exclusiveGiftlLayout = view.findViewById(R.id.vip4ExclusiveGiftlLayout);
        hideCountryOnlineLlayout = view.findViewById(R.id.vip4HideCountryOnlineLlayout);
        sendButton = view.findViewById(R.id.vip4SendBtn);
        buyButton = view.findViewById(R.id.vip4BuyBtn);

        vip4CoinsTV = view.findViewById(R.id.vip4CoinsTV);
        vip4YouAreVipTV = view.findViewById(R.id.vip4YouAreVipTV);

        framesImg4 = view.findViewById(R.id.framesImg4);
    }
    ...
    private void clicks(View view) {
        ...
        sendButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                bundle.putString("giftType","VIP 4");
    ...
    private void setDialogs(View view) {
        ...
        friendLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                vip1FriendTv1.setText("x400");
                vip1FriendTv2.setText("Friends *400%");
                vip1FriendTv3.setText("Increase your Friends limit *400%");
        ...
        followingLyout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                vip2FollowingTv1.setText("x400%");
                vip2FollowingTv2.setText("Following *400%");
                vip2FollowingTv3.setText("Increase your Following limit *400%");
        ...
        coinsDayLlayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                vip1CoinsTv1.setText("+7000");
                vip1CoinsTv2.setText("7000 coins/day");
                vip1CoinsTv3.setText("Get 7000 coins/day in Daily Reward. Refresh time. UTC+0");
