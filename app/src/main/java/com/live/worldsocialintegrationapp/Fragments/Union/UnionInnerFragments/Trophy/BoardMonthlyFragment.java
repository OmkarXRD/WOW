...
public class BoardMonthlyFragment extends Fragment implements AdapterRooms.Callback{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_board_monthly, container, false);
    }
    @Override
    ...
    private void findIds(View view) {
        ...
        rv_daily = view.findViewById(R.id.monthlyrecycler_Board);

        dailyTop1DiamondTv = view.findViewById(R.id.monthlyTop1DiamondTv);
        dailyTop3DiamondTv = view.findViewById(R.id.monthlyTop3DiamondTv);
        dailyTop2DiamondTv = view.findViewById(R.id.monthlyTop2DiamondTv);

        profile_photo2 = view.findViewById(R.id.monthly1Profile_photo2);
        profile_photo3 = view.findViewById(R.id.monthly1profile_photo3);
        profile_photo1 = view.findViewById(R.id.monthly1profile_photo1);

    }

    private void boardApi() {

        new Mvvm().getWowsBoard(requireActivity(), "reciever", "3").observe(requireActivity(), new Observer<WowsBoardRoot>() {
            @Override
                ...
                if (wowsBoardRoot != null) {
                    if (wowsBoardRoot.getSuccess().equalsIgnoreCase("1")) {
                        ...
                        if (list.isEmpty()) {
                            ...
                            try {
                                adapterRooms = new AdapterRooms(list, requireContext(), BoardMonthlyFragment.this);
