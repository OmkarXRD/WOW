...
public class Fragment_Daily extends Fragment implements AdapterRooms.Callback {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment__daily, container, false);
    }
    ...
    private void findIds(View view) {
        ...
        rv_daily = view.findViewById(R.id.recycler_Board);

        dailyTop1DiamondTv = view.findViewById(R.id.dailyTop1DiamondTv);
        dailyTop3DiamondTv = view.findViewById(R.id.dailyTop3DiamondTv);
        dailyTop2DiamondTv = view.findViewById(R.id.dailyTop2DiamondTv);

        profile_photo2 = view.findViewById(R.id.profile_photo2);
        profile_photo3 = view.findViewById(R.id.profile_photo3);
        profile_photo1 = view.findViewById(R.id.profile_photo1);

    }

    private void boardApi() {

        new Mvvm().getWowsBoard(requireActivity(), "reciever", "1").observe(requireActivity(), new Observer<WowsBoardRoot>() {
            @Override
                ...
                if (wowsBoardRoot != null) {
                    if (wowsBoardRoot.getSuccess().equalsIgnoreCase("1")) {
                        ...
                        if (list.isEmpty()) {
                            ...
                            adapterRooms = new AdapterRooms(list, requireContext(), Fragment_Daily.this);
