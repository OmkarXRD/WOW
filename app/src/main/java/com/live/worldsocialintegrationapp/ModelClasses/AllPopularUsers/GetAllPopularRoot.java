...
public class GetAllPopularRoot implements Serializable {
    ...
    public class Detail {
        ...
        @SerializedName("GalleryAppliedImage")
        @Expose
        private String galleryAppliedImage;
        ...
        public String getGalleryAppliedImage() {
            return galleryAppliedImage;
        }

        public void setGalleryAppliedImage(String galleryAppliedImage) {
            this.galleryAppliedImage = galleryAppliedImage;
        }
