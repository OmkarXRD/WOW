package com.live.worldsocialintegrationapp.ModelClasses.BlockUser;
...
public class RootBlocked {
        ...
        public class Detail {
            ...
            @SerializedName("toBlocker")
            @Expose
            private String toBlocker;
            @SerializedName("id")
            @Expose
            private String id;
            @SerializedName("name")
            ...
            public String getToBlocker() {
                return toBlocker;
            }

            public void setToBlocker(String toBlocker) {
                this.toBlocker = toBlocker;
            }
