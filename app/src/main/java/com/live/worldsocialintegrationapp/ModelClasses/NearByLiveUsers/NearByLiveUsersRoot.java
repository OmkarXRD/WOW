...
public class NearByLiveUsersRoot implements Serializable {
    ...
    public class Detail {
        ...
        @Expose
        public String bool;
        @SerializedName("userLive_Password")
        @Expose
        public String userLivePassword;
        ...
        public String getUserLivePassword() {
            return userLivePassword;
        }

        public void setUserLivePassword(String userLivePassword) {
            this.userLivePassword = userLivePassword;
        }
