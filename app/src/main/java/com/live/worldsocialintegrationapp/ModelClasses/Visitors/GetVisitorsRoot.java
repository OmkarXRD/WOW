...
public class GetVisitorsRoot implements Serializable {

    public String status;
    public String success;
    public String message;
    public ArrayList<Deatil> deatils;

    public ArrayList<Deatil> getDeatils() {
        return deatils;
    }

    public void setDeatils(ArrayList<Deatil> deatils) {
