...
import com.live.worldsocialintegrationapp.databinding.ListRequestMultiliveBinding;
...
public class PKLiveUserAdapter extends RecyclerView.Adapter<PKLiveUserAdapter.ViewHolder> {
    ...
    private List<PKLiveUserModel.Dimaond> dimaond;
    private Click click;


    public PKLiveUserAdapter(Context context, List<PKLiveUserModel.Dimaond> dimaond, Click click) {
    ...
    public interface Click {
        void setOnSendPKInvitationListener(PKLiveUserModel.Dimaond dimaond);
    }
}
