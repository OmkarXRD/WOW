...
import com.live.worldsocialintegrationapp.databinding.ListUserLiveJoinedBinding;
...
public class UserJoinedAdapter extends RecyclerView.Adapter<UserJoinedAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull @NotNull ViewHolder holder, int position) {
        ...
        if (position == 0) {
            ...
            if ( App.getSharedpref().getString("userId").equalsIgnoreCase(goLiveModelClasses.get(position).getUserID())) {
