...
import com.live.worldsocialintegrationapp.databinding.ListUsersBinding;
...
public class ViewerAdapter extends RecyclerView.Adapter<ViewerAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull @NotNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(view -> {
            //agr live host true aa ta means jiski live hai vohi dekh skta hai
//            if (!liveStatus.equalsIgnoreCase("host")) {

                click.onBanned(position,!liveStatus.equalsIgnoreCase("host"));
//            }
        });
    ...
    public interface Click {
        void onBanned(int position,boolean liveHost);
    }
}
